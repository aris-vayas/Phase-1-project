...
//renderOurcollection (like toytale/ booklist)
        ...
        let divCard = document.getElementById("anime-collection");
        let searchBtn = document.getElementById("search-anime-btn");
        let autocomplete = document.getElementById("autocomplete");
        
        function handleAnime(dat) {
            ...
            div.className = "card";
            h2.textContent = dat.title;
            image.src = dat.image_url;
            image.className = "anime-avatar";
            // p.textContent = dat.synopsis;
            button.className = "like-btn";
            button.setAttribute("id", dat.id);
            button.textContent = " Like ❤️ "
            div.append(h2, image, button);
            divCard.append(div);
        
        
            button.addEventListener("click", function(e) {
                handleLikes(e, elemen, p);
